...
const Header = () => {
    ...
    return (
        <section id="home" className="relative min-h-screen section-container overflow-hidden">
            {/* Animated Background Elements */}
            <div className="absolute inset-0">
                {floatingWords.map((word, index) => (
                    <div
                        key={word}
                        className={`absolute text-6xl font-bold text-[var(--text-muted)] animate-pulse opacity-20 select-none
            ...
            <div className="relative mx-[120px] py-20">
                <div className="flex justify-between items-center min-h-[80vh]">
                    ...
                    <div className={`flex-1 pr-12 transform transition-all duration-1000 ${
                        ...
                        {/* Premium Badge */}
                        <div className="inline-flex items-center gap-2 card rounded-full px-4 py-2 mb-6 shadow-sm animate-pulse">
                            <Sparkles className="w-4 h-4 text-yellow-500" />
                            <span className="text-sm font-medium text-secondary">Proven by Top Creators</span>
                        </div>

                        {/* Main Heading */}
                        <div className="mb-6">
                            <h1 className="text-[50px] font-extrabold leading-tight text-primary">
                        ...
                        <div className="flex gap-4">
                            <button className="btn-primary group relative px-8 py-4 rounded-2xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 overflow-hidden">
                        ...
                        <div className="flex items-center gap-6 mt-8 text-sm text-muted">
                            <div className="flex items-center gap-2">
                                <div className="flex -space-x-2">
                                    {[1,2,3,4].map(i => (
                                        <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-r from-pink-400 to-purple-400 border-2 border-[var(--card-bg)]"></div>
                                    ))}
                                </div>
